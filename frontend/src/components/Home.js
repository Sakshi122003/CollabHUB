...
const LanguageItem = ({ icon: Icon, title, description }) => (
  ...
  >
    <Avatar sx={{ width: 80, height: 80, bgcolor: "#36C2CE", mb: 2 }}>
        ...
        >
          <Grid container spacing={4} alignItems="center">
            <Grid
              ...
              className="hero-text"
              color="#071952"
              sx={{ fontFamily: "Roboto, sans-serif", color: "#071952" }}
            >
              <AnimatedTitle
              ...
              <Box mt={4}>
                ...
                <Button
                  ...
                  sx={{
                    ...
                    "&:hover": {
                      background: "#B0E0FF",
                      border: "2px solid #451952", // Width, style, and color
                    },
                  }}
                  size="large"
                  onClick={() =>
    ...
    // ... other sections ...
    {
      ...
      title: (
        ...
        >
          ...
          >
            <Box sx={{ borderTop: "3px solid #088395", mt: 2.5 }} />
          </Box>
          <Typography
            variant="h4"
            sx={{
      ...
      content: (
        <>
          ...
          >
            ...
            experience.
            <u>
              Click on the cards below to learn more about each panel and its
              specific features.
            </u>
          </Typography>
      ...
      content: (
        <Box>
          <Box
            sx={{
              mt: 2,
              bgcolor: "#CAF4FF", // Changed background color to #CAF4FF
              color: "#180161",
              boxShadow: "0px 8px 16px rgba(0, 0, 139, 0.3)",
