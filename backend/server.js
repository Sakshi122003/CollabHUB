    ...
    const mailOptions = {
      ...
      html: `
        ...
        <ul>
          ...
          <li>Contact: ${contactData.countryCode} ${contactData.contactNumber}</li>
          <li>Availability Start Date: ${new Date(contactData.availabilityStartDate).toLocaleDateString()}</li>
        </ul>
